...
-- Listage des données de la table schoolmanager.messenger_messages : ~1 rows (environ)
...
-- Listage des données de la table schoolmanager.user : ~2 rows (environ)
INSERT INTO `user` (`id`, `email`, `username`, `roles`, `password`, `is_verified`) VALUES
	(1, 'victor@bearformation.com', 'Victor', '["ROLE_FORMATEUR"]', '$2y$13$S/hfNbCQ7P.zM7eA9q7fneEyi520FD736UL5T8FMSiu59ZQouTfFy', 1),
